...
struct EditingView: View {
    ...
    @ViewBuilder
    private var frameExportSection: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            if frameImageFormat == .jpeg {
                Picker("JPEG Quality", selection: Binding(get: { frameJPEGQualityPreset }, set: { frameJPEGQualityPreset = $0 })) {
                ...
                if frameJPEGQualityPreset == .custom {
                    Stepper("Quality \(frameCustomJPEGQuality)", value: $frameCustomJPEGQuality, in: JPEGQuality.validRange)
                        .disabled(controlsDisabled)
                }
    ...
    @ViewBuilder
    private var intervalFrameExportSection: some View {
        VStack(alignment: .leading, spacing: 10) {
